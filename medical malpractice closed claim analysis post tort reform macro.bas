...
Public Sub BuildClean_Post()
    ...
    For r = 2 To lastRow
        ...
        wsC.Cells(r, "B").Value = wsR.Cells(r, "AA").Value    ' Final Disposition Date
        wsC.Cells(r, "C").Value = wsR.Cells(r, "O").Value     ' Injury Severity
    ...
    MsgBox "POST data processed: " & (lastRow - 1) & " rows.", vbInformation
