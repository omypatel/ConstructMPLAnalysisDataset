...
Log_Indemnity = log10(Indemnity_Paid)
...
Paste the FLOIR export into the "Raw" sheet.

Run the appropriate preprocessing macro.

Apply the log transformation macro to the Clean sheet.

Export or analyze the processed dataset as needed.
